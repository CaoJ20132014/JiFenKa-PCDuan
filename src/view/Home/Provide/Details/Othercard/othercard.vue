<template>
    <div class="reachge_box" id="reachge">
        ...
        <div v-show="show" class="pagination">
            <el-pagination @current-change="handleCurrentChange" :current-page.sync="currentPage" layout="prev, pager, next, jumper, total" :page-size="5" :total="total"></el-pagination>
        </div>
    </div>
</template>
<script>
