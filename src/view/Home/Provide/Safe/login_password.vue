  ...
  <div>
    ...
    <div class="content_bot border">
      <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
        <el-form-item label="原始 密码" prop="passold">
          <img class="keyboard" src="../../../../assets/image/Provide/web/keyboard.png" alt="">
          <el-input type="password" v-model="ruleForm2.passold" auto-complete="off" placeholder="原密码">
          </el-input>
          <small>6-12位字符，首字母不为数字</small>
        </el-form-item>
        <el-form-item label="重置新密码" prop="passnew">
          <img class="keyboard" src="../../../../assets/image/Provide/web/keyboard.png" alt="">
          <el-input type="password" v-model="ruleForm2.passnew" auto-complete="off" placeholder="6-12位字符，首字母不为数字"></el-input><small>6-12位字符，首字母不为数字</small>
        </el-form-item>
        <el-form-item label="确认新密码" prop="checkPass">
          <img class="keyboard" src="../../../../assets/image/Provide/web/keyboard.png" alt="">
          <el-input type="password" v-model="ruleForm2.checkPass" auto-complete="off" placeholder="确认新密码"></el-input><small>6-12位字符，首字母不为数字</small>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" style="width:140px;border:1px solid #8A63E7;" @click="submitForm('ruleForm2')">提交设置</el-button>
          <el-button style="width:140px;" @click="submitForm('ruleForm2')">取消设置</el-button>
        </el-form-item>
      </el-form>
      <div class="bottom">
        <p class="tip">温馨提示</p>
