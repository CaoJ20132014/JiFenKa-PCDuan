<template>
    ...
    <div class="content_bot border">
      ...
      <div class="account">
        <div class="icon-box">
          <img src="../../../assets/web/account.png" alt="">
        </div>
        <div class="form-info">
...
<style scoped>
  ...
  .form-info{width: 670px;display: inline-block;}
  .header-tip,.foot{
    width: 670px;
  }
  .header-tip{
 ...
 .ruleForm{width: 350px;margin-top:20px;}
  .el-input .el-input__inner{background: #fff;}
.foot p{line-height: 30px;}
.foot{padding: 10px 0;border-top:1px solid #e6e6e6;}
.foot span{margin-right: 10px;}
.foot small{color: #b5b5b5;}
.foot a{float:right;}
