<template>
	<div class="provide_box border">
		<div class="content_top">
			...
			<img v-show="isShow" src="../../../../assets/right_gou.png" alt="">
			<div>{{title}}</div>
		</div>
	...
	export default {
		...
		methods:{
			...
			changecardNum:function(){				// 改变单张供卡和多张供卡的下边框
				...
				if (router == "/home/provide/card/"||router == "/home/provide/fulecard/"){
					this.flag = '1';
				} else if (router == "/home/provide/card/manycard"||router == "/home/provide/fulecard/manyfuel"||router == "/home/provide/fulecard/fuelconfim"){
					this.flag = '2';
				}
			},
			changeStyle:function() {
				let router = this.$route.path;
				if (router == "/home/provide/card/"||router == "/home/provide/card/manycard") {
					this.title = "上网卡供货";
					this.isShow = true;
					this.hidden = true;
					this.cardType = '1';
				} else if (router == "/home/provide/fulecard/"||router == "/home/provide/fulecard/manyfuel"||router == "/home/provide/fulecard/fuelconfim") {
					this.title = "加油卡供货";
					this.isShow = true;
					this.hidden = true;
					this.cardType = '2';
